            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="<?php echo e(route('home')); ?>"><i class="fa fa-cash"></i> <strong>e-</strong><strong>Wallet</strong></a>
                    </div>
                    <!-- end:navbar-header -->
                    ...
                    <ul class="nav navbar-nav navbar-right top-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('profile')); ?>"><i class=" fa fa-suitcase"></i>Profile</a></li>
                                <li><a href="<?php echo e(route('client.logout')); ?>"><i class="fa fa-key"></i> Log Out</a></li>
                                <?php else: ?>
                                <li><a href="<?php echo e(route('login')); ?>"><i class=" fa fa-sign-in"></i>Log In</a></li>
                                <li><a href="<?php echo e(route('register')); ?>"><i class=" fa fa-sign-up"></i>Register</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    </ul>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo e(route('paywithpaypal')); ?>"><i class="fa fa-money"></i>From Paypal</a></li>
                                        <li><a href="<?php echo e(route('cardview')); ?>"><i class="fa fa-credit-card"></i>From Card</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo e(route('transaction')); ?>"><i class="fa fa-list-alt"></i> Transaction History</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo e(route('help')); ?>"><i class="fa fa-question-circle"></i> Help & Support</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="<?php echo e(route('client.logout')); ?>"><i class="fa fa-unlock-alt"></i> LogOut</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
