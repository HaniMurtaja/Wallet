                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="names" value="<?php echo e($client->names); ?>" id="inputEmail1" placeholder="Names">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Contacts</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="contact" value="<?php echo e($client->contact); ?>" id="inputEmail1" disabled placeholder="contact">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Email</label>
                                        <div class="col-lg-10">
                                            <input type="email" class="form-control" name="email" value="<?php echo e($client->email); ?>" id="inputEmail1" placeholder="Email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">API Secret Key</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control" name="key" value="<?php echo e($client->secret_key); ?>" id="inputEmail1" placeholder="Secret Key" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
